...
<main>
  <section class="grid-con">
      ...
      <div class=" col-span-full m-col-start-1 m-col-end-7 l-col-start-1 l-col-end-7 xl-col-start-1 xl-col-end-7" id="contact-header">
          <h2>I would<i class="fa brands fa-heart"></i> to hear from you!</h2>
          <p>Thanks for checking out my portfolio!</p>  <p>If you're interested in working together or just want to say hi, fill out the form below and let's get in touch.</p> <p> Just a heads up though, I'm a hugger, but since we're living in the age of social distancing, let's keep a safe distance for now.</p> <p>But don't worry, we can still create some amazing designs together, even if it's from a distance. Can't wait to hear from you!</p>
      </div>

      <div class=" col-span-full m-col-start-7 m-col-end-13 l-col-start-7 l-col-end-13 xl-col-start-7 xl-col-end-13" id="contact-form">
        <section>
          <h2 class="hidden">Contact Form</h2>
            <form action="#">
