  ...
  <div class="grid-con">
    <div class="col-span-full m-col-start-2 m-col-end-9 l-col-start-1 l-col-end-9" id="about-me">
      <div >  
        ...
        <p class="text-matrix">Aside from my silly side, I take my work seriously and I'm passionate about creating designs that are not only aesthetically pleasing but also effective in delivering the message. With over a decade of experience in graphic design, I've had the opportunity to work on various projects, from print media to events and production.</p>
