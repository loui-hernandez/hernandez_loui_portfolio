...
<main>
  ...
  <section class="grid-con">
    ...
    <div class=" col-span-full m-col-start-1 m-col-end-7 l-col-start-1 l-col-end-7 xl-col-start-1 xl-col-end-7" id="projectsDetails">
        <h1>PROJECT NAME:</h1> 
        ...
        <h4>Objective</h4>
        <p>Ceci Cosmetics is a new business in the beauty products industry, approached me to create a logo that reflected their innovative and modern brand identity.</p>
    
        <h4>Solution</h4>
        <p>After conducting a thorough brand analysis and getting input from the client, I created a logo design that combined a clean, minimalist font with a graphic element that represented the company's focus on technology and innovation. The color scheme was selected to reflect the brand's values of trust, professionalism, and creativity.</p>
    
        <h4>Result</h4>
        <p>The final logo design was well received by the client and successfully communicated the brand's identity to their target audience. The logo was used on the company's website, social media profiles, and marketing materials, helping to establish a strong visual presence in the industry.</p>
        <img src="images/ceci branding/ceci-Brand Values.webp" alt="">
      </div>

      <div class="col-span-full m-col-start-7 m-col-end-13 l-col-start-7 l-col-end-13" id="">
        <div id="ceci-logo">
    ...
    <footer>
      <section class="col-span-full footer-main-nav">
        <div class="soc-med-footer">
          <a href="https://www.linkedin.com/in/leh-0819"><img src="images/linkedin.svg" alt="LinkedIn Icon" class="soc-med-icon"></a>
